...
public class AdminRegister implements RegisterUser{
	...
	public void register() {
		...
		System.out.println("Admin, welcome to Bank of ABC registration page");
		...
		User newUser = new User (userName, password, firstName, lastName, 1);
